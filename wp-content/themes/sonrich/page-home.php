...
<?php get_template_part( 'template-parts/inner', 'banner' ); ?>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="circle-area">
                                <div class="image-1 my-5">
                                    <img src="<?php echo get_template_directory_uri(); ?>/inc/images/Featured_product4.png" alt="img"
                                        class="img-1 d-block m-auto float-none float-lg-end">
                                </div>
                                <div class="circle">
                                    <div class="circle-content">
                                        <img src="<?php echo get_template_directory_uri(); ?>/inc/images/Sonrich_international.png" alt="logo" class="circle-image">
        ...
        <!--Third Section Start-->
        <div class="container-fluid stay-se">
            <div class="stay">
                <img src="<?php echo get_template_directory_uri(); ?>/inc/images/blue-moving.jpeg" alt="blue moving" class="blue-move">
                <div class="row t-1 mt-4">
                    <div class="col-12 col-lg-6">
                ...
                <div class="row mt-4">
                    <div class="col-md-6">
                        <div class="people-img">
                            <img src="<?php echo get_template_directory_uri(); ?>/inc/images/peoples.png" alt="" class="left-side-image">
                        </div>
                    </div>
                    <div class="col-md-6">
