...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css"
    ...
    <link href="https://fonts.googleapis.com/css2?family=Catamaran:wght@100;200;300;400;600;700;800;900&display=swap" rel="stylesheet">
	...
	<header>
            ...
            <div class="navigation-bar">
                <nav class="navbar navbar-expand-lg navbar-light container p-0">
                    <a class="navbar-brand" href="<?php echo get_home_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/inc/images/Sonrich_international.png" alt="logo"></a>
                    ...
                    <form class="d-flex ms-2" role="search">
                                <input class="form-control navbar-search me-2 ms-auto" type="search"
